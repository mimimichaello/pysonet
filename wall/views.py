...
from base.permissions import IsAuthor, IsAuthorCommentEntry
from .models import Post, Comment
from .serializers import CreateCommentSerializer, PostSerializer, ListPostSerializer
...
class CommentsView(CreateUpdateDestroy):
    """Редактирование комментариев к посту"""
